...
SOURCEFILES_QUOTED_IF_SPACED=src/usb/usb_descriptors.c src/usb/usb_events.c src/usbframework/usb_device.c src/usbframework/usb_device_hid.c src/config.c src/main.c src/knobly/kbly_hid.c src/knobly/kbly_matrix.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/src/usb/usb_descriptors.p1 ${OBJECTDIR}/src/usb/usb_events.p1 ${OBJECTDIR}/src/usbframework/usb_device.p1 ${OBJECTDIR}/src/usbframework/usb_device_hid.p1 ${OBJECTDIR}/src/config.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/knobly/kbly_hid.p1 ${OBJECTDIR}/src/knobly/kbly_matrix.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/src/usb/usb_descriptors.p1.d ${OBJECTDIR}/src/usb/usb_events.p1.d ${OBJECTDIR}/src/usbframework/usb_device.p1.d ${OBJECTDIR}/src/usbframework/usb_device_hid.p1.d ${OBJECTDIR}/src/config.p1.d ${OBJECTDIR}/src/main.p1.d ${OBJECTDIR}/src/knobly/kbly_hid.p1.d ${OBJECTDIR}/src/knobly/kbly_matrix.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/src/usb/usb_descriptors.p1 ${OBJECTDIR}/src/usb/usb_events.p1 ${OBJECTDIR}/src/usbframework/usb_device.p1 ${OBJECTDIR}/src/usbframework/usb_device_hid.p1 ${OBJECTDIR}/src/config.p1 ${OBJECTDIR}/src/main.p1 ${OBJECTDIR}/src/knobly/kbly_hid.p1 ${OBJECTDIR}/src/knobly/kbly_matrix.p1

# Source Files
SOURCEFILES=src/usb/usb_descriptors.c src/usb/usb_events.c src/usbframework/usb_device.c src/usbframework/usb_device_hid.c src/config.c src/main.c src/knobly/kbly_hid.c src/knobly/kbly_matrix.c
